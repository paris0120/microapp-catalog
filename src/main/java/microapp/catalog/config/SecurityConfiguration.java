package microapp.catalog.config;
...
import microapp.catalog.security.oauth2.AudienceValidator;
import microapp.catalog.security.oauth2.JwtGrantedAuthorityConverter;
import microapp.catalog.web.filter.SpaWebFilter;
