...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './catalog.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATALOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATALOG actions', async () => {
      const expectedActions = [
        {
