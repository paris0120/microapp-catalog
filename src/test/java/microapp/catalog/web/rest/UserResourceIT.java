...
import microapp.catalog.config.Constants;
import microapp.catalog.domain.Authority;
import microapp.catalog.domain.User;
import microapp.catalog.repository.AuthorityRepository;
import microapp.catalog.repository.EntityManager;
import microapp.catalog.repository.UserRepository;
import microapp.catalog.security.AuthoritiesConstants;
import microapp.catalog.service.dto.AdminUserDTO;
import microapp.catalog.service.mapper.UserMapper;
