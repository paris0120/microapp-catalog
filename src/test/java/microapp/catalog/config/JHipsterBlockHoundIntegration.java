...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("microapp.catalog.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("microapp.catalog.security.DomainUserDetailsService", "createSpringSecurityUser");
